...
각 judge 의 cand × accuracy 벡터에 대해 Pearson correlation 계산 (상세는 [Judge correlation 분석 글](/blog/rag-llm-judge-correlation-analysis) 참고).
...
- **Q2 + Q4 통합 분석** 별도 글: [4-Quadrant 종합](/blog/rag-llm-judge-summary-4quadrant-matrix)
- **Judge correlation 정량 분석**: [별도 글](/blog/rag-llm-judge-correlation-analysis)
